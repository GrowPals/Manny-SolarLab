    ...
    <div className="space-y-6 md:space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="col-span-1 sm:col-span-2 pt-5 md:pt-8 border-t border-slate-100">
              <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4 md:gap-6">
                <div className="w-full md:w-auto">
                   <p className="text-[9px] md:text-[10px] text-slate-500 uppercase tracking-wider font-bold mb-1 md:mb-2">Total con IVA</p>
                ...
                <div className="w-full md:w-auto bg-slate-50 md:bg-transparent p-3 md:p-0 rounded-xl md:text-right border border-slate-100 md:border-none flex justify-between md:block items-center mt-2 md:mt-0">
                    <p className="text-[9px] md:text-[10px] text-slate-500 uppercase tracking-wider font-bold mb-0 md:mb-2 mr-4 md:mr-0">Retorno (ROI)</p>
        ...
        <Card gradient className="p-5 md:p-8 text-white border-none flex flex-col justify-center relative overflow-hidden shadow-2xl shadow-[#DE3078]/20">
          ...
          <div className="relative z-10">
            ...
            <div className="mb-5 md:mb-8">
              <p className="text-[9px] md:text-[10px] font-bold text-white/70 uppercase tracking-wider mb-1 md:mb-2">Deducción ISR (30%)</p>
            ...
            <div className="pt-5 md:pt-6 border-t border-white/20">
              <p className="text-[9px] md:text-[10px] font-bold text-white/70 uppercase tracking-wider mb-1 md:mb-2">Inversión Neta Real</p>
              <p className="text-xl md:text-3xl font-bold">${financials.netCost.toLocaleString()}</p>
              <p className="text-[9px] md:text-[10px] text-white/60 mt-2 font-medium leading-relaxed">Art. 34 Frac. XIII LISR</p>
            </div>
          </div>
        </Card>
      </div>
      ...
      <Card className="p-5 md:p-8">
        ...
        <div className="grid md:grid-cols-3 gap-4 md:gap-6 mt-5 md:mt-8">
          <div className="bg-white rounded-2xl md:rounded-3xl p-4 md:p-6 border border-slate-100 shadow-sm hover:shadow-lg transition-all hover:-translate-y-1">
            ...
            <p className="text-[9px] md:text-[10px] text-slate-500 font-medium leading-relaxed">30% de la inversión base recuperable en declaración anual</p>
          </div>
          ...
          <div className="bg-white rounded-2xl md:rounded-3xl p-4 md:p-6 border border-slate-100 shadow-sm hover:shadow-lg transition-all hover:-translate-y-1">
            ...
            <p className="text-[9px] md:text-[10px] text-slate-500 font-medium leading-relaxed">Recuperable para personas morales y PFAE</p>
          </div>
          ...
          <div className="bg-white rounded-2xl md:rounded-3xl p-4 md:p-6 border border-slate-100 shadow-sm hover:shadow-lg transition-all hover:-translate-y-1">
            ...
            <p className="text-[9px] md:text-[10px] text-slate-500 font-medium leading-relaxed">Monto recuperable inmediato</p>
          </div>
        </div>
      </Card>
      ...
      <Card className="p-5 md:p-8">
        ...
        <div className="mb-6 md:mb-10 p-5 md:p-8 bg-slate-50 rounded-2xl md:rounded-3xl border border-slate-100">
          ...
          />
          <div className="flex justify-between text-[9px] md:text-[10px] font-bold text-slate-400 mt-3 md:mt-4 uppercase tracking-wider">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-6">
          <div className="bg-white rounded-2xl md:rounded-3xl p-4 md:p-6 text-center border border-slate-100 shadow-sm hover:border-slate-200 transition-colors flex flex-row md:flex-col justify-between md:justify-center items-center">
            <p className="text-[9px] md:text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-0 md:mb-2">Payback</p>
            <p className="text-lg md:text-4xl font-black text-slate-900 tracking-tight">{financials.paybackYears} <span className="text-[9px] md:text-sm text-slate-400 font-bold">años</span></p>
          </div>
          <div className="bg-white rounded-2xl md:rounded-3xl p-4 md:p-6 text-center border border-slate-100 shadow-sm hover:border-slate-200 transition-colors flex flex-row md:flex-col justify-between md:justify-center items-center">
            <p className="text-[9px] md:text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-0 md:mb-2">Ahorro 25 años</p>
            <p className="text-lg md:text-4xl font-black text-emerald-600 tracking-tight">${(financials.totalSavings/1000000).toFixed(1)}M</p>
          </div>
          <div className="bg-white rounded-2xl md:rounded-3xl p-4 md:p-6 text-center border border-slate-100 shadow-sm hover:border-slate-200 transition-colors flex flex-row md:flex-col justify-between md:justify-center items-center">
            <p className="text-[9px] md:text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-0 md:mb-2">ROI Total</p>
            <p className="text-lg md:text-4xl font-black text-purple-600 tracking-tight">{financials.roi25}%</p>
          </div>
        </div>
      </Card>
      ...
      <Card className="p-5 md:p-8">
        ...
        <div className="h-64 md:h-96 w-full -ml-2 md:ml-0 min-w-0">
          <ResponsiveContainer width="99%" height="100%">
            <AreaChart data={financials.projection.slice(0, isPlaying ? currentAnimYear : 26)}>
              <defs>
            ...
            <table className="w-full text-xs">
              <thead className="bg-slate-50 sticky top-0">
                <tr>
                  ...
                  <th className="p-3 md:p-4 text-right font-bold text-slate-600">Gasto CFE</th>
                  <th className="p-3 md:p-4 text-right font-bold text-slate-600">Ahorro</th>
                  <th className="p-3 md:p-4 text-right font-bold text-slate-600">Acumulado</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-slate-100">
                {financials.projection.map((row) => (
                  <tr key={row.year} className="hover:bg-slate-50 transition-colors">
                    <td className="p-3 md:p-4 font-medium text-slate-500">{row.year}</td>
                    <td className="p-3 md:p-4 text-right text-red-500 font-medium">-${row.cfeWithoutSolar.toLocaleString()}</td>
                    <td className="p-3 md:p-4 text-right text-emerald-600 font-bold">+${row.savings.toLocaleString()}</td>
